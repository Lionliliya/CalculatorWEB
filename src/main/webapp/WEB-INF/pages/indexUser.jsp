...
<!-- Begin page content -->
<div class="container">
  <div class=".col-xs-4">Hi, ${user.username}!</div>
  ...
  <div class="col-xs-6 .col-md-4">
    <form method="post" action="/calculate/${user.id}">
      <div class="row">
    ...
    <div class="row">
      ...
      <a href="/${user.id}"><button type="button" class="btn btn-lg btn-success">Try again</button></a>
    </div>
...
<div id="footer">
  <div class="container">
    ...
    <div class=".col-xs-4"><a href="/logout/${user.id}" class="text-muted">Sign out</a></div>
  </div>
</div>
</body>
</html>
